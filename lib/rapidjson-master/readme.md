![RapidJSON logo](docs/logo/rapidjson.png)
...
More features can be read [here](docs/features.md).
...
* Added [JSON Pointer](docs/pointer.md)
* Added [JSON Schema](docs/schema.md)
* Added [relaxed JSON syntax](docs/dom.md) (comment, trailing comma, NaN/Infinity)
* Iterating array/object with [C++11 Range-based for loop](docs/tutorial.md)
...
directory. The generated documentation will be available in `docs/html`
...
![simpledom](docs/diagram/simpledom.png)
...
* SAX API
  ...
  * [jsonx](https://github.com/Tencent/rapidjson/blob/master/example/jsonx/jsonx.cpp): Implements a `JsonxWriter` which stringify SAX events into [JSONx](https://www-01.ibm.com/support/knowledgecenter/SS9H2Y_7.1.0/com.ibm.dp.docs/json_jsonx.html) (a kind of XML) format. The example is a command line tool which converts input JSON into JSONx format.
